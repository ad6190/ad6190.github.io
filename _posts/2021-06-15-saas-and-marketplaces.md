...
I am pretty convinced that unless one has a better distribution channel figured already, curated marketplaces are the way to go for initial product launch. If you're building for accounting, find accounting marketplaces. For dev tools, go to github/gitlab marketplaces, productivity - go to slack, trello marketplaces. A product that uses a marketplace to amplify and can also have a standalone existence should be an ideal start for a b2b saas business, esp as a solo founder. 
